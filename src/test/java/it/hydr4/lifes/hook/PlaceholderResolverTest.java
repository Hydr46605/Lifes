...
class PlaceholderResolverTest {
    ...
    private final LivesService service = new DefaultLivesService(directory, () -> new it.hydr4.lifes.config.LivesSettings(
        3, 10, 1, java.util.Set.of(), java.util.List.of(), java.util.List.of(), java.util.List.of(), java.util.List.of(), it.hydr4.lifes.config.ZeroLivesJoin.REAPPLY, 0, true, null));
