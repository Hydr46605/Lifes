...
| Java | 21 |
| Release | [v0.4.2](https://github.com/Hydr46605/Lifes/releases/tag/v0.4.2) |
...
| `%lifes_dead_<n>%` | Exact username at position `n` (1-based) of the dead list, empty when out of range |
